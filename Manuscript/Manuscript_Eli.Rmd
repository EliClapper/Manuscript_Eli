...
abstract: |
  Rating written summaries and using the ratings as a fair proxy for text quality is a time-costly procedure that is prone to rater variability. Computerized techniques that aid the automatic scoring of text can aid the procedure. Previous research has tried to identify quality-reflecting text features to be used in automatization techniques, but the statistical models have been subject to overfitting and multicollinearity, leading to imprecise results. This thesis views the issue in a machine learning framework to help aid the rating automatization and to identify quality-reflecting text features. It is shown that.... and .... this implies that ... and ...
...
```
  <p class = "caption"><em>Figure 1.</em> Graphical Representation of the Thesis</p>
</div>
